#!/usr/bin/env node
/* =============================================================================
   Regenerates assets/snapshot.js — the fallback data embedded in the page.
...
function parseArgs(argv) {
  const out = { fixtures: null, outPath: path.join(ROOT, 'assets', 'snapshot.js'), dryRun: false };
...
function serialise(payload) {
  ...
  return `/* Auto-generated by tools/build-snapshot.js — do not edit by hand.
   ...
   Regenerate: node tools/build-snapshot.js */
